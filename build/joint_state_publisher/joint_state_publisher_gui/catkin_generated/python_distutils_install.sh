...
echo_and_run cd "/home/frank/Desktop/raskar_ws/raskar/src/joint_state_publisher/joint_state_publisher_gui"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/frank/Desktop/raskar_ws/raskar/src/joint_state_publisher/joint_state_publisher_gui/setup.py" \
    build --build-base "/home/frank/Desktop/raskar_ws/raskar/build/joint_state_publisher/joint_state_publisher_gui" \
    install \
    $DESTDIR_ARG \
