...
echo_and_run cd "/home/frank/ws_raskar_kinetic/src/ultrasound/rosserial_python"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/frank/ws_raskar_kinetic/src/ultrasound/rosserial_python/setup.py" \
    build --build-base "/home/frank/ws_raskar_kinetic/build/ultrasound/rosserial_python" \
    install \
    $DESTDIR_ARG \
