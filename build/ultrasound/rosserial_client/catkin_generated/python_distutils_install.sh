...
echo_and_run cd "/home/frank/Desktop/raskar_ws/raskar/src/ultrasound/rosserial_client"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/frank/Desktop/raskar_ws/raskar/src/ultrasound/rosserial_client/setup.py" \
    build --build-base "/home/frank/Desktop/raskar_ws/raskar/build/ultrasound/rosserial_client" \
    install \
    $DESTDIR_ARG \
