...
echo_and_run cd "/home/frank/Desktop/raskar_ws/raskar/src/ultrasound/rosserial_vex_v5"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/frank/Desktop/raskar_ws/raskar/src/ultrasound/rosserial_vex_v5/setup.py" \
    build --build-base "/home/frank/Desktop/raskar_ws/raskar/build/ultrasound/rosserial_vex_v5" \
    install \
    $DESTDIR_ARG \
