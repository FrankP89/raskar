...
if("TRUE" STREQUAL "TRUE")
  set(rplidar_ros_SOURCE_PREFIX /home/frank/ws_raskar_urdf/src/rplidar)
  set(rplidar_ros_DEVEL_PREFIX /home/frank/ws_raskar_urdf/devel)
  ...
  set(rplidar_ros_INSTALL_PREFIX /home/frank/ws_raskar_urdf/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rplidar_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/frank/ws_raskar_urdf/src/rplidar/${idir}'.  ${_report}")
    endif()
