...
echo_and_run cd "/home/frank/Desktop/raskar_ws/raskar/src/joint_state_publisher/joint_state_publisher"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/frank/Desktop/raskar_ws/raskar/src/joint_state_publisher/joint_state_publisher/setup.py" \
    build --build-base "/home/frank/Desktop/raskar_ws/raskar/build/joint_state_publisher/joint_state_publisher" \
    install \
    $DESTDIR_ARG \
