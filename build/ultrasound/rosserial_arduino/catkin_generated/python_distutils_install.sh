...
echo_and_run cd "/home/frank/Desktop/raskar_ws/raskar/src/ultrasound/rosserial_arduino"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/frank/Desktop/raskar_ws/raskar/src/ultrasound/rosserial_arduino/setup.py" \
    build --build-base "/home/frank/Desktop/raskar_ws/raskar/build/ultrasound/rosserial_arduino" \
    install \
    $DESTDIR_ARG \
