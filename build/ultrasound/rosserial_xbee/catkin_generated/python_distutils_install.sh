...
echo_and_run cd "/home/frank/Desktop/raskar_ws/raskar/src/ultrasound/rosserial_xbee"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/frank/Desktop/raskar_ws/raskar/src/ultrasound/rosserial_xbee/setup.py" \
    build --build-base "/home/frank/Desktop/raskar_ws/raskar/build/ultrasound/rosserial_xbee" \
    install \
    $DESTDIR_ARG \
