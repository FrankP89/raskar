...
echo_and_run cd "/home/frank/ws_raskar_kinetic/src/ultrasound/rosserial_vex_v5"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/frank/ws_raskar_kinetic/src/ultrasound/rosserial_vex_v5/setup.py" \
    build --build-base "/home/frank/ws_raskar_kinetic/build/ultrasound/rosserial_vex_v5" \
    install \
    $DESTDIR_ARG \
